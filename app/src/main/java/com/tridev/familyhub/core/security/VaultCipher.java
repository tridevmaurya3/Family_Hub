...
public final class VaultCipher {
    ...
    private static SecretKey key() throws Exception {
        ...
        return ((KeyStore.SecretKeyEntry) store.getEntry(ALIAS, null))
                .getSecretKey();
    }
    ...
    /**
     * Strict variant used while creating a portable backup. It must never
     * silently replace a secret with an error message inside the archive.
     */
    @NonNull
