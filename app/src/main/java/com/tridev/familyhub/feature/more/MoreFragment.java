...
public class MoreFragment extends Fragment {
    @Nullable @Override public View onCreateView(@NonNull LayoutInflater i,@Nullable ViewGroup c,@Nullable Bundle s){
        ...
        root.addView(card("Privacy & About","LifeHub Family Edition • Version 0.3.0",v->new MaterialAlertDialogBuilder(requireContext()).setTitle("LifeHub Family Edition").setMessage("Private, offline-first family organizer. Adult location and documents must only be shared with explicit consent.").setPositiveButton("OK",null).show()));return scroll;
    }
